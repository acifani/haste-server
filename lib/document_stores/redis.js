...
RedisDocumentStore.connect = function(options) {
  var host = process.env.REDIS_HOST || options.host || '127.0.0.1';
  var port = process.env.REDIS_PORT || options.port || 6379;
  var index = options.db || 0;
  var password = process.env.REDIS_PASSWORD || options.password;
